...
# Add missing links for flows that need inputs
library(magrittr)
pp_model <- pp_model %>%
  add_link(from = "Predator", to = "predation") %>%
  add_link(from = "Prey", to = "predator_growth") %>%
  add_link(from = "Predator", to = "predator_growth")
