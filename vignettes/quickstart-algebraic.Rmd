...
# The old syntax: X %+% (X %->% decay %->% NULL) still works
decay_model <- X %->% decay %->% NULL
...
**New in v0.2.0**: Stocks used in connections are automatically included!

### Combination Operator: `%+%`
Combines components:
```{r eval = FALSE}
# Old style (explicit stocks)
model <- stock1 %+% stock2 %+%
         (stock1 %->% flow1 %->% stock2)

# New style (automatic stock inclusion) - preferred!
